      ...
      <div style={{
        ...
        onMouseLeave={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
          ...
          <div style={{lineHeight: '1.8'}}>
            ...
            <p style={{margin: '0.3rem 0', opacity: '0.95', color: 'white'}}>Level 24, West Tower,</p> 
            <p style={{margin: '0.3rem 0', opacity: '0.95', color: 'white'}}>World Trade Centre,</p>
            <p style={{margin: '0.3rem 0', opacity: '0.95', color: 'white'}}>Colombo 01, Sri Lanka</p>
          </div>
        </div>
